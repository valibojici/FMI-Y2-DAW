...
<div class="container d-flex mt-5 justify-content-center">
    <form action="process_signup.php" class="signup-form p-5 rounded-3 col-12 col-md-8 col-lg-5 col-xl-4" method="post">
        ...
        <div class="input-wrapper m-3">
            ...
            <input type="text" id="nume" name="firstname"  class="p-1 w-100" value="<?php echo $fname ?? '' ?>">
            <?php if($fname_error) : ?>
                <div class="text-danger">Error: <?php echo $fname_error; ?> </div>
            <?php endif; ?>

            <div class="mt-3">Last Name</div>
            <input type="text" id="prenume" name="lastname" class="p-1 w-100" value = "<?php echo $lname ?? '' ?>">
            <?php if($lname_error) : ?>
                <div class="text-danger">Error: <?php echo $lname_error; ?> </div>
            <?php endif; ?>
        
            <div class="mt-3">Phone number</div>
            <input type="text" id="telefon" name="phone" class="p-1 w-100" value="<?php echo $phone ?? '' ?>">
            <?php if($phone_error) : ?>
                <div class="text-danger">Error: <?php echo $phone_error; ?> </div>
            <?php endif; ?>
        
            <div class="mt-3">Email</div>
            <input type="text" id="email" name="email" class="p-1 w-100" value="<?php echo $email ?? '' ?>">
            <?php if($email_error) : ?>
        ...
        <div class="g-recaptcha" data-sitekey="6Lczd7odAAAAAHImqW8Q6MqYYiq8_3rM4K5sJmSn"></div>
